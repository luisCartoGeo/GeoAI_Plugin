...
from .modeling_f.image_encoder_f import ImageEncoderViT
from .modeling_f.mask_decoder_hq import MaskDecoderHQ
from .modeling_f.prompt_encoder_f import PromptEncoder_f
from .modeling_f.sam_f import Sam
from .modeling_f.tiny_vit_sam import TinyViT
from .modeling_f.transformer import TwoWayTransformer
...
def build_sam_vit_t(checkpoint=None):
    ...
    mobile_sam = Sam(
            ...
            prompt_encoder=PromptEncoder_f(
